                                    ...
                                    <h4 className="description">{port.description}</h4>
                                        <div style={{display: 'flex', gap: '10px'}}>
                                            <button
                                                ...
                                                aria-label={port.url && port.url.includes('drive.google') ? 'View on Google Drive' : 'View on GitHub'}
                                                title={port.url && port.url.includes('drive.google') ? 'View on Google Drive' : 'View on GitHub'}
                                            >
                                                {
                                                    // If the URL is a Google Drive link, show the Drive logo; otherwise show GitHub logo
                                                    port.url && (port.url.includes('drive.google') || port.url.includes('docs.google') || port.url.includes('drive.googleusercontent')) ? (
                                                        // Use the external SVG asset for the official Drive logo
                                                        <img src={driveLogo} alt="Google Drive" width="18" height="18" />
                                                    ) : (
